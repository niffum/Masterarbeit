...
Beispielsweise stellen \cite{Voinea16} eine AR-Anwendung vor die den Lernprozess im Bereich der Biomechanik unterstützt.
...
Ein weiter Ansatz zur Erzeugung von 3D-Modellen des Herzens wird von \cite{SORENSEN2001193} beschrieben. Hier soll das Modell ebenfalls in eine VR-Anwendung integriert werden, um von Ärzten als Vorbereitung auf eine Operation genutzt werden. 
...
\cite{hansen03} stellen ein Shading Modell vor, dass realistisches Rendering von transluzenten Materialien erlaubt.
...
\cite{Fong17} beschreiben Volume Rendering unter Verwendung von Path Tracing, vobei der Fokus auf dessen Einsatz in der Produktion liegt.
